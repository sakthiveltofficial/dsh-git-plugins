    ...
    ctx.tools.register(defineTool({
        ...
        async execute(args, exec) {
            ...
            switch (a.action) {
                case 'record': {
                    if (!a.kind || !a.text)
                        throw new Error('git_memory record requires `kind` and `text`');
